import { ChartType } from '../models/list.model';
...
const tasks = [
  {
    index: 1,
    taskType: 'upcoming',
    name: 'Review Term sheet from Big Inc',
  ...
  },
  {
    index: 2,
    taskType: 'upcoming',
    name: 'Small Tradning Client has passed KYB',
  ...
  },
  {
    index: 3,
    taskType: 'upcoming',
    name: 'Contact Mike Jones at That Company Limited',
